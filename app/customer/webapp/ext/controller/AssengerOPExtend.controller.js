sap.ui.define(
	...
	function (ControllerExtension, Message, MessageType) {
		...
		return ControllerExtension.extend(
			"sap.fe.cap.customer.ext.controller.PassengerOPExtend",
			{
				// this section allows to extend lifecycle hooks
				// or hooks provided by Fiori elements
				override: {
					/**
					 ...
					 */
					onInit: function () {
						// you can access the Fiori elements extensionAPI
						// via this.base.getExtensionAPI
						var oModel = this.base
							.getExtensionAPI()
							.getModel();
					},
